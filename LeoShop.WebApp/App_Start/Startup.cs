...
using LeoShop.Application.Services;
using LeoShop.Data.Infrastructure;
using LeoShop.Data.Models;
using LeoShop.Data.Repositories;

[assembly: OwinStartup(typeof(LeoShop.WebApp.App_Start.Startup))]

namespace LeoShop.WebApp.App_Start
{
